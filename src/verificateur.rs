...
//     let uuid_transaction = message.id;
...
//     // Verifier signature du message (idempotent)
//     if let Err(e) = message.verifier_signature() {
//         warn!("Message invalide : {:?}", e)
//     }
//     let (signature_valide, hachage_valide) = match &message.contenu_valide {
