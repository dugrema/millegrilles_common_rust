...
// use crate::bson::Bson;
//
// use crate::certificats::{emettre_commande_certificat_maitredescles, FingerprintCertPublicKey, ValidateurX509, VerificateurPermissions};
...
//     -> Result<CleSecrete, crate::error::Error>
// {
//     let cle_secrete = {
//         let cle_bytes = match multibase::decode(cle) {
//             Ok(inner) => inner.1,
//             Err(e) => Err(crate::error::Error::Multibase(e))?
//         };
//
//         // Determiner le type de cle. Supporte RSA et ED25519.
//         match private_key.id() {
...
//             _ => Err(crate::error::Error::Str("Unsupported key format - only Ed25519 and RSA are supported"))
//         }
//     }?;
//
//     Ok(cle_secrete)
...
//     fn dechiffrer_cle(&mut self, cle_privee: &PKey<Private>) -> Result<(), crate::error::Error>;
// }
//
// pub trait MgsCipherKeys {
//
//     fn get_dechiffrage(&self, enveloppe_demandeur: Option<&EnveloppeCertificat>)
//         -> Result<DechiffrageInterMillegrilleOwned, crate::error::Error>;
//
...
//     ) -> Result<CommandeSauvegarderCle, crate::error::Error>;
//
...
//             TypeMessage::Certificat(m) => &m.enveloppe_certificat,
//             TypeMessage::Regeneration => return Ok(())
//         };
//
